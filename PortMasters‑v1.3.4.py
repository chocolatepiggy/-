...
class MaritimeTradeGameGUI:
    ...
    def save_game(self):
        ...
        try:
            ...
            messagebox.showinfo("Save Success", "Progress Saved!")
        except Exception as e:
            self.log_message(f"❌ Save failed: {str(e)}")
            messagebox.showerror("Save Failed", f"Cannot save game: {str(e)}")
    ...
    def fire_worker(self, worker_type, index):
        ...
        if worker_type == "weaver":
            ...
            wage = self.MASTER_WEAVER_WAGE
            worker_name = "Master Weaver"
        elif worker_type == "sachet_maker":
            worker_list = self.sachet_makers
            wage = self.SACHET_MAKER_WAGE
            worker_name = "Sachet Maker"
        else:
            return False
    ...
    def show_worker_management(self, in_phase=False):
        ...
        tk.Label(inventory_frame, text="📦 Current Inventory",
        ...
        tk.Label(materials_frame, text="Raw Materials:",
        ...
        tk.Label(products_frame, text="Finished Goods:",
                 font=("Microsoft YaHei", 12, "bold"),
                 bg="#F0F8FF",
                 fg=self.colors["accent_blue"]).pack(anchor=tk.W)
        ...
        tk.Label(hire_frame, text="🔨 Hire Workers",
                 font=("Microsoft YaHei", 18, "bold"),
                 bg=self.colors["worker_bg"],
                 fg=self.colors["bg_dark"]).pack(pady=10)
        workers_info = [
            ("👩‍🔧 Weaver", f"Making: Linen Clothes(2 Hemp) or Cotton Clothes(2 Hemp+1 Silk)\nWage: {self.WEAVER_WAGE} Gold/Round"),
            ("👩‍🎨 Master Weaver", f"Making: Linen Clothes, Cotton Clothes or Brocade(3 Silk)\nWage: {self.MASTER_WEAVER_WAGE} Gold/Round"),
            ("🌸 Sachet Maker", f"Making: Sachet(1 Silk+2 Tea)\nWage: {self.SACHET_MAKER_WAGE} Gold/Round")
        ]
        ...
        if self.weavers or self.master_weavers or self.sachet_makers:
            ...
            tk.Label(status_frame, text="👥 Worker Status & Tasks",
                     font=("Microsoft YaHei", 18, "bold"),
                     bg="#F0F8FF",
                     fg=self.colors["bg_dark"]).pack(pady=10)
            if self.weavers:
    ...
    def create_ship_panel(self, parent):
        ...
        ship_frame = ttk.LabelFrame(parent, text="🚢 Ship Status", padding="8", style="DarkFrame.TLabelframe")
    ...
    def create_inventory_panel(self, parent):
        ...
        inv_frame = ttk.LabelFrame(parent, text="📦 Cargo Hold", padding="3", style="DarkFrame.TLabelframe")
        ...
        tk.Label(scrollable_frame, text="━━ Raw Materials ━━",
        ...
        tk.Label(scrollable_frame, text="━━ Finished Goods ━━",
                 font=("Microsoft YaHei", 9, "bold"),
                 bg=self.colors["bg_light"],
        ...
        if self.weavers or self.master_weavers or self.sachet_makers:
            tk.Frame(scrollable_frame, height=1, bg=self.colors["accent_blue"]).pack(fill=tk.X, pady=5, padx=5)
            tk.Label(scrollable_frame, text="━━ Workers ━━",
                     font=("Microsoft YaHei", 9, "bold"),
                     bg=self.colors["bg_light"],
                     fg=self.colors["accent_blue"]).pack(anchor=tk.W, pady=(5, 2), padx=5)
            workers_info = [
                (f"👩‍🔧 Weavers", len(self.weavers)),
                (f"👩‍🎨 Masters", len(self.master_weavers)),
    ...
    def create_phase_panel(self, parent):
        ...
        self.phase_frame = ttk.LabelFrame(parent, text="🌊 Trade Phases", padding="15", style="DarkFrame.TLabelframe")
    ...
    def create_log_panel(self, parent):
        ...
        log_frame = ttk.LabelFrame(parent, text="📜 Voyage Log", padding="5", style="DarkFrame.TLabelframe")
    ...
    def show_purchase_interface(self):
        ...
        main_container = ttk.Frame(self.phase_content, style="DarkFrame.TLabelframe")
        main_container.pack(fill=tk.BOTH, expand=True, padx=15, pady=15)
        tk.Label(tk.Frame(main_container, bg=self.colors["bg_light"]), text="⚓ Port Goods Purchase",
    ...
    def show_orders_interface(self):
        ...
        main_container = ttk.Frame(self.phase_content, style="DarkFrame.TLabelframe")
        main_container.pack(fill=tk.BOTH, expand=True, padx=15, pady=15)
        tk.Label(tk.Frame(main_container, bg=self.colors["bg_light"]), text="🤝 Trade Orders",
                 font=("Microsoft YaHei", 20, "bold"),
                 bg=self.colors["bg_light"], fg=self.colors["bg_dark"]).pack(anchor=tk.W, pady=(0, 15))
        cards_container = tk.Frame(main_container, bg=self.colors["bg_light"])
        cards_container.pack(fill=tk.BOTH, expand=True)
    ...
    def start_phase3(self):
        ...
        tk.Label(maintenance_frame, text="🔧 Ship Maintenance", font=("Microsoft YaHei", 24, "bold"),
    ...
    def start_phase4(self):
        ...
        tk.Label(current_card, text="📊 Current Status", font=("Microsoft YaHei", 22, "bold"),
        ...
        tk.Label(upgrade_card, text="⚡ Upgrade Options", font=("Microsoft YaHei", 22, "bold"),
        ...
        if self.ship_level < 3:
            ...
            tk.Label(upgrade_card, text=f"🔼 Upgrade to Level {next_level}",
            ...
            for label_text, value_text in details:
                ...
                tk.Label(detail_frame, text=value_text, font=("Microsoft YaHei", 16, "bold"),
                         bg="#F0F8FF",
                         fg=self.colors["accent_red"] if "Cost" in label_text else self.colors["accent_green"]).pack(
                    side=tk.RIGHT)
            ...
            tk.Label(max_level_frame, text="🎉 Fully Upgraded!", font=("Microsoft YaHei", 24, "bold"),
        ...
        buttons_frame.pack()
        buttons = [
            ("📖 Upgrade Rules", self.show_upgrade_rules),
            ("⏭️ Skip Upgrade", self.skip_upgrade),
    ...
    def end_game(self):
        ...
        tk.Label(result_frame, text="🎮 Game Over!", font=("Microsoft YaHei", 32, "bold"),
                 bg=self.colors["bg_light"], fg=self.colors["bg_dark"]).pack(pady=20)
    ...
    def restart_game(self):
        ...
        if messagebox.askyesno("Restart Voyage", "Confirm restarting the maritime journey?"):
            self.inventory = {"Hemp": 8, "Silk": 5, "Tea": 3, "Linen Clothes": 0, "Cotton Clothes": 0, "Brocade": 0, "Sachet": 0}
            self.money = 100
            self.score = 0
            self.current_round = 1
            self.ship_level = 0
